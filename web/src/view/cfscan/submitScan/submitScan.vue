<template>
  <div>
    <div class="gva-search-box">
      <el-form ref="elSearchFormRef" :inline="true" :model="searchInfo" class="demo-form-inline" :rules="searchRule"
        ...
        <el-form-item label="扫描类型" prop="scanType">
          <el-select v-model="searchInfo.scanType" clearable placeholder="请选择"
                     @clear="()=>{searchInfo.scanType=undefined}">
        ...
        <el-form-item label="任务状态" prop="scanStatus">
          <el-select v-model="searchInfo.scanStatus" clearable placeholder="请选择"
                     @clear="()=>{searchInfo.scanStatus=undefined}">
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
          <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateSubmitScanFunc(scope.row)">
              查看
            </el-button>
    ...
    <el-drawer destroy-on-close size="800" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
      ...
      <el-form class="row-form" :model="formData" :disabled="formIsFormView" label-position="top" ref="elFormRef"
               :rules="rule" label-width="80px">
        <el-form-item label="扫描简介:" prop="scanDesc">
          <el-input v-model="formData.scanDesc" :clearable="true" placeholder="请输入扫描简介"/>
        </el-form-item>
        <el-form-item label="扫描类型:" prop="scanType">
          <el-select v-model="formData.scanType" placeholder="请选择扫描类型" style="width:100%" :clearable="true"
                     @change="handleScanTypeChange">
            <el-option v-for="(item,key) in CFScanTypeOptions" :key="key" :label="item.label" :value="item.value"/>
          </el-select>
        </el-form-item>
        <el-form-item label="ASN编号:" prop="asnNumber">
          <el-input v-model="formData.asnNumber" :disabled="isAsnDisabled" :clearable="true"
                    placeholder="请输入ASN编号,多个ASN用,分割"/>
        </el-form-item>
        <el-form-item label="IP类型:" prop="ipinfoType">
          <el-select v-model="formData.ipinfoType" :disabled="isIpDisabled" placeholder="请选择IP类型"
        ...
        <el-form-item label="IP信息列表:" prop="ipinfoList">
          <el-input :row="4" type="textarea" :disabled="isIpDisabled" v-model="formData.ipinfoList" :clearable="true"
                    placeholder="请输入IP信息列表"/>
        </el-form-item>
        ...
        <el-form-item label="开启IP测速:" prop="enableSpeedtest">
          <el-select v-model="formData.enableSpeedtest" placeholder="请选择开启IP测速" style="width:100%"
                     :clearable="true">
