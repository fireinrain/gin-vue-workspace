...
import (
	gvaGlobal "github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/global"
	"github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/model/system"
	"github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/plugin/plugin-tool/utils"
{{- if .HasGlobal }}
	"github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/plugin/{{ .Snake}}/global"
{{- end }}
	"github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/plugin/{{ .Snake}}/router"
