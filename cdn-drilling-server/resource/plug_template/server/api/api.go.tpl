...
{{ if .NeedModel }}	"github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/plugin/{{ .Snake}}/model" {{ end }}
	"github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/plugin/{{ .Snake}}/service"
