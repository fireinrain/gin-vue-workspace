...
import (
    ...
    "github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/model/{{.Package}}"
    {{.Package}}Req "github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/model/{{.Package}}/request"
    "github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/model/common/response"
    "github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/service"
    "github.com/gin-gonic/gin"
    "go.uber.org/zap"
    {{- if .AutoCreateResource}}
    "github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/utils"
    {{- end }}
)
