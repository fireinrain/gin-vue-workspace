...
import (
	...
	ast2 "github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/utils/ast"

	"github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/resource/autocode_template/subcontract"
...
func Init(Package string) {
	...
	packageInjectionMap = map[string]astInjectionMeta{
		packageServiceName: {
			...
			importCodeF:  "github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/%s/%s",
			packageNameF: "%s",
