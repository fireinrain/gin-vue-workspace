...
import (
	"github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/plugin/email/global"
	"github.com/fireinrain/gin-vue-workspace/cdn-drilling-server/plugin/email/router"
